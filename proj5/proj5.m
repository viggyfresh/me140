...
T_air_in_stack = TA_data(:,12)'; %celsius
T_air_out_stack = TA_data(:,13)'; 
T_water_reservoir = TA_data(:,14)'; 
T_water_in_stack = TA_data(:,15)'; 
T_water_before_HeatExchange = TA_data(:,16)'; 
T_stack = TA_data(:,17)'; 
P_air_in = TA_data(:,9)';  %GAUGE!
P_H2_in = TA_data(:,11)';  %GAUGE!
