...
for i=1:length(rpm)
    ...
    [Ma4(i), To4(i), T4(i), Po4_ratio(i)] = ...
        zachStuart(Tm4(i), p4(i), m_dot(i), A4, RF_c);
    [Ma5(i), To5(i), T5(i), Po5_ratio(i)] = ...
        zachStuart(Tm5(i), pt5(i), m_dot(i), A5, RF_a);
    [Ma8(i), To8(i), T8(i), Po8_ratio(i)] = ...
        zachStuart(Tm8(i), pt8(i), m_dot(i), A8, RF_c);
end
...
eta_turb = deltaH_var_cp(To5, To4, length(rpm)) ...
           ./ deltaH_var_cp(To5s, To4, length(rpm));
